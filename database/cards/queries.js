const addCard = 'INSERT INTO cards (id, barcode, balance, customer_name, customer_id, is_member, is_active, dine_in, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW(), NOW()) RETURNING *'; //change
