const addCard = 'INSERT INTO cards (id, barcode, balance, customer_name, is_member, is_active, dine_in, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, NOW(), NOW())';
...
const cardStatus = 'UPDATE cards SET dine_in = $1, customer_name = $2, balance = $3, updated_at = NOW() WHERE barcode = $4';
